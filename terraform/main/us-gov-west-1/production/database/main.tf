module "rds" {
  ...
  ca_cert_identifier                  = lookup(each.value, "ca_cert_identifier", "rds-ca-rsa4096-g1")
  ...
  instance_class                      = lookup(each.value, "instance_class", "db.r6g.xlarge")
  use_serverless                      = lookup(each.value, "use_serverless", false)
