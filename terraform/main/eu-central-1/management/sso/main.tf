...
module "sso_algo_high_group_memberships" {
  source    = "../../../../modules/management/sso/group-membership"
  for_each  = toset(var.sso_group_memberships["algo_high"].member_id)
  group_id  = module.sso_groups["algo_high"].group_id
  member_id = module.sso_users[each.value].user_id
}
...
module "sso_devops_basic_group_memberships" {
  source = "../../../../modules/management/sso/group-membership"

  for_each  = toset(var.sso_group_memberships["devops_basic"].member_id)
  group_id  = module.sso_groups["devops_basic"].group_id
  member_id = module.sso_users[each.value].user_id
}

module "sso_qa_ecr_group_memberships" {
  source = "../../../../modules/management/sso/group-membership"

  for_each  = toset(var.sso_group_memberships["qa_ecr"].member_id)
  group_id  = module.sso_groups["qa_ecr"].group_id
  member_id = module.sso_users[each.value].user_id
}
