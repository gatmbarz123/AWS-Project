cloudtrail_centralized_s3_bucket_name = "mng-euc1-example-cloudtrail-management-events"
cloudtrail_name                       = "management-events"
cloudtrail_log_group_class            = "STANDARD"
cloudtrail_admin_emails               = ["user@example.com", "user@example.com"]
...
config_centralized_s3_bucket_name = "mng-euc1-limitsless-config-management-events"
...
allowed_ip_addresses         = ["10.33.0.0/16"]
