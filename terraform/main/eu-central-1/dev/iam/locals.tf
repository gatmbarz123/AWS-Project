locals {
  ...
  service_accounts = {
    ...
    ec2-scheduler-windows = {
      clusters             = ["dev-euc1-python-ai-eks"],
      service_account_path = "system:serviceaccount:ec2-scheduler-windows:ec2-scheduler-windows-sa"
      inline_policies = [
        file("${var.policy_applications_path}/ec2_scheduler_policy.json.tpl")
      ]
    }
  }
