cloudtrail_centralized_s3_bucket_name = "mng-use1-example-cloudtrail-management-events"
cloudtrail_name                       = "management-events"
cloudtrail_log_group_class            = "STANDARD"
cloudtrail_admin_emails               = ["user@example.com", "user@example.com", "user@example.com"]
security_detail_types                 = ["AWS API Call via CloudTrail", "GuardDuty Finding"]
security_sources                      = ["aws.ec2", "aws.iam", "aws.kms", "aws.guardduty", "aws.inspector2"]
...
security_event_sources                = ["iam.amazonaws.com", "ec2.amazonaws.com", "kms.amazonaws.com", "guardduty.amazonaws.com", "inspector2.amazonaws.com"]

#------------------------------------------------------ AWS Cloudtrail

#------------------------------------------------------ AWS Config

config_centralized_s3_bucket_name = "mng-use1-limitsless-config-management-events"
...
manage_service_linked_role = false

#-------------------------------------------------------------------------- WAF 

waf_ip_set_scope             = "REGIONAL"
waf_ip_set_addresses_version = "IPV4"
allowed_ip_addresses         = ["10.43.0.0/16"]
